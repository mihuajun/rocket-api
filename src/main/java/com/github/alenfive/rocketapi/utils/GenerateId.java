 ...
 */
public final class GenerateId implements Comparable<GenerateId>, Serializable {
     ...
     * @param date the date
     */
    public GenerateId(final Date date) {
     ...
     */
    public GenerateId(final Date date, final int counter) {
     ...
     */
    public GenerateId(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public GenerateId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private GenerateId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     */
    public GenerateId(final String hexString) {
     ...
     */
    public GenerateId(final byte[] bytes) {
     ...
     */
    GenerateId(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
     ...
     * @since 3.4
     */
    public GenerateId(final ByteBuffer buffer) {
    ...
    public boolean equals(final Object o) {
        ...
        GenerateId objectId = (GenerateId) o;
    ...
    @Override
    public int compareTo(final GenerateId other) {
        if (other == null) {
